...
NowHun:		rcall	SendChar;Send Thousands
		ldi	Temp3,LOW(1000)
		add	Temp1,Temp3
		ldi	Temp3,HIGH(1000)
		adc	Temp2,Temp3
...
NowTen:		rcall	SendChar;Send hundreds
		ldi	Temp3,100
		add	Temp1,Temp3
		clr	Temp3
...
DoTen:		subi	Temp1,10
		...
		;Last digit is just sent
NowUnit:	subi	Temp3,-48
		rcall	SendChar;Send Tens
		ldi	Temp3,10
		add	Temp3,Temp1
		ret

SendChar:	subi	Temp3,-48
		sbis	USR,UDRE
		rjmp	SendChar
		out	UDR,Temp3
		ret
